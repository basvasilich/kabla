        ...
        <div class="row">
            <div class="span15">
                <div class="b-catalog__promo">
                    <div class="bg"></div>
                    <p>Представляем вам список подарочных карт, из которого вы можете выбирать любые на своё усмотрение и в соответствии с доступной суммой на вашем балансе.</p>
					<p>
						...
						Подарочная карта будет доставлена вам по адресу, который вы сможете указать при оформлении заказа.
					</p>
           			<p class="team"><b>Команда Бумкарты</b><br/><span>+7 495 933 95 93</span><br/><span>+7 800 100 95 93</span></p>
					<h2>Ваш текущий баланс &#151; 0 баллов</h2>
                </div>
            </div>
        </div>
        {#include list root=$T}
        ...
        <div class="partner-form">
            ...
            <div class="card-form">
                {#foreach $T.features[0].amount.options as option}
                        <a class="btn" style="font-style:italic;font-size:9pt">{$T.option}&nbsp;<span class="rub">q</span></a>
                {#/for}
            </div>
        </div>
        <form class="params">
